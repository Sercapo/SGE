...
class GCF(models.Model):
    ...
    centro_id = fields.Integer('Identificador Del Centro', required=True)

    nombre = fields.Char('Nombre del Centro', required=True)

    ciclos_id = fields.Many2many('ciclos', string='Ciclos',index =True)